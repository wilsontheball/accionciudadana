package ar.com.thinksoft.ac.wilsond.resources;
...
import ar.com.thinksoft.ac.wilsond.jaxb.FlightType;
...
public class FlightList {
	...
	/**
	 * This class is annotated with @Singleton meaning that only one instance of
	 * this class will be instantated per web application.
	 * <p>
	 * The flight lists will be constructed just once when the first request to
	 * the flight list resource occurs.
	 */
	public FlightList() {
